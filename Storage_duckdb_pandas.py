...
# Global lock to prevent concurrent view creation
_view_creation_lock = threading.Lock()
...
def register_parquet_views(con: duckdb.DuckDBPyConnection, db_name: str) -> None:
    # Use global lock to prevent concurrent view creation
    with _view_creation_lock:
        for table in TABLE_DATE_COLUMN:
